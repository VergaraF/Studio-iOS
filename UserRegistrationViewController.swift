            ...
            case .success(let grantedPermissions, let declinedPermissions, let accessToken):
                ...
                FIRAuth.auth()?.signIn(with: credential) { (user, error) in
                    ...
                    if UserDefaults.standard.object(forKey: "uid") != nil{
                        ...
                        alert.showSuccess("Welcome back", subTitle: "You have been taken to our tutors hub. Please select one subject you need tutors on!")

                        //SEGUEY TO TUTOR CARDS (ACTUALLY, SUBJECTS COLLECTION VIEW)
                        self.performSegue(withIdentifier: "goToSubjects", sender: self)
                        ...
                        self.performSegue(withIdentifier: "isItTutorOrStudent", sender: self)
